...
export const metadata = {
  title: 'Djazzy: Write Cleaner, Faster, Scalable Django Code',
  alternates: {
    canonical: `${ROUTES.POSTS}/projects/djazzy`,
  },
};
...
🔧 Want to check out the code? Here's the [GitHub Repo](https://github.com/software-trizzey/djazzy-vscode).
</blockquote>

<blockquote className="aside">
⚠️ Status update: This project is now deprecated due to the advent of AI coding agents, which cover most of the workflow Djazzy was built for.
</blockquote>
